...
// Verificar se é admin (usa flag is_admin definida na sessão)
verificar_admin();
...
<head>
    ...
    <style>
        * {
        ...
        .navbar {
            background: linear-gradient(135deg, #667eea 0%, #792e72ff 100%);
            color: white;
            padding: 15px 30px;
            display: flex;
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="navbar-right">
            <a href="../index.php" class='nav-link' id="nav-voltar">🛠️ Voltar para Menu</a>
    ...
    <script>
        // função de confirmação in-site para o painel admin
        ...
        async function logout() {
            const ok = await showConfirmAdmin('Tem certeza que deseja sair?', 'Sair');
            if (!ok) return;
            try {
