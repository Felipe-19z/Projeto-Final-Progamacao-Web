...
3. **Crie o banco de dados**:
   ...
   - Execute o SQL do arquivo `database.sql`

4. **Preencha o formulário** e clique em "Inicializar Sistema"

### Opção 2: Setup Manual

1. **Edite `config.php`** com suas credenciais MySQL:
   ```php
   define('DB_USER', 'seu_usuario');
   define('DB_PASS', 'sua_senha');
   ```

2. **Execute o SQL** em phpMyAdmin

3. **Crie seu primeiro usuário** via `/admin/criar-usuarios.php`
...
3. Acesse: `http://localhost/Projeto-Final/admin/`
