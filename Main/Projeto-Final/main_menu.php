...
// Usuário logado permanece no menu principal
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <div class="container">
        <?php if (isset($_SESSION['usuario_id'])): ?>
            <form action="logout.php" method="post" style="text-align:right; margin-bottom:20px;">
                <button type="submit" style="background:#ff6b6b;color:#fff;border:none;padding:10px 20px;border-radius:8px;cursor:pointer;">Sair</button>
            </form>
        <?php endif; ?>
